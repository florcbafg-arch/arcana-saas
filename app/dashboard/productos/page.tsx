...
const createProduct = async () => {
  ...
  try {
    ...
    // =========================================
    if (!editingId && newBarcode.trim()) {
      const businessId =
        localStorage.getItem('activeBusinessId')

      if (businessId) {
        const { data: existingProduct, error: duplicateError } =
          await supabase
            .from('products')
        ...
        if (duplicateError) {
          console.error(
            'ERROR VALIDANDO PRODUCTO DUPLICADO:',
            duplicateError
          )
          ...
          setToast({
            type: 'error',
            message:
              'No pudimos verificar si el producto ya existe. Intentá nuevamente.'
          })
...
{/* ================================================= */}
{/* PRODUCTOS MOBILE — EDITAR PRODUCTO */}
{/* ================================================= */}
      ...
      >
        <div className="flex gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-white font-semibold text-lg leading-5">

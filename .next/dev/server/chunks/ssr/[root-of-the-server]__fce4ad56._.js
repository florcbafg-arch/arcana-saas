...
function OnboardingPage() {
    ...
    const handleCreateBusiness = async ()=>{
        ...
        const { data: business, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('businesses').insert({
            name: businessName,
            owner_id: user.id,
            plan_type: 'pro',
        ...
        const { error: relationError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('business_users').insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fce4ad56._.js.map